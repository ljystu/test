        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/Reader/registerReader" method="post" id="readerRegister">
                ...
                <div class="input-group" style="padding-top: 20px;">
                    ...
                    <input type="text" class="form-control" name="readerType" id="readerType"
                           placeholder="teacher or student" maxlength="20">
                </div>
                <div class="input-group" style="padding-top: 20px;">
                    <span class="input-group-addon">密码</span>
                    <input type="password" class="form-control" name="readerPwd" id="readerPwd" maxlength="20"
